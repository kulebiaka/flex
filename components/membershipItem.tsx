...
const membershipItem = (
  ...
  return (
    <div className='w-[315px] h-[488px] rounded-[30px] bg-[#f2f2f2] shadow-[3px_3px_6px_black] overflow-hidden relative text-[#0d0d0d]'>
      <div className='h-[140px] flex flex-col justify-center overflow-hidden bg-center bg-cover bg-no-repeat md:h-[75px] ' style={{backgroundImage: `url(${img.src})`}}>
        <h3 className='text-white text-[32px] uppercase font-bold text-center z-10 mx-auto w-full '>{tittle}</h3>
      </div>
      <div>
